...
<head>
    <meta charset="UTF-8">
    <title>NTTI Parking Management System</title>
    <link rel="icon" href="{{ asset('assets/images/car.svg') }}">
    ...
    <style rel="stylesheet" href="{{ asset('assets/css/form_login.css') }}"></style>
</head>
